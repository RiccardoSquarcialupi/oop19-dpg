...
A partire dalla classe GridGenerator e dal suo unico metodo generate(), vengono creati prima una Grid (modello del Tabellone di Gioco), e poi una GridView (view del Tabellone), che si basa sulla Grid creata.
%
