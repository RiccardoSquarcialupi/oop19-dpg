...
\begin{document}
    ...
    \end{figure}
    TurnManager gestisce i PlayerController durante il corso della partita, decidendone l'ordine dei turni e svolgendo le operazioni da svolgere alla fine di ogni turno (quali l'esecuzione dei minigiochi).
    %
    ...
    %
    Il gamecycle crea un thread che esegue le operazioni in background, aggiurnando la view quando necessario.
    %
    ...
    %
    Permette di selezionare il livello, ottenere informazioni sulla partita ad ogni frame e salvare lo stato delle direzioni scelte dall'utente.
    ...
    %
    Questo permette la creazione di diversi livelli in maniera agevole.
    %
